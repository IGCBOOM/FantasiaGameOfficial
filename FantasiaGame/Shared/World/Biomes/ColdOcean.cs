...
namespace FantasiaGame.Shared.World.Biomes
{
    public class ColdOcean : Biome
    {
        ...
        public override string ID { get; } = "cold_ocean";
        ...
        public override double Temperature { get; } = 15;
        public override Color BiomeColor { get; } = Color.LightSeaGreen;
        public override Color MapBiomeColor { get; } = Color.Turquoise;
